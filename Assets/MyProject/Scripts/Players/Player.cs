...
using MyProject.Scripts.Players.StateMachine;
...
namespace MyProject.Scripts.Players
{
    public class Player : MonoBehaviour
    {
        ...
        [SerializeField] private AnimationControllerSecond _animationControllerSecond;
        ...
        private void Start()
        {
            ...
            Dictionary<Type, PlayerStateBase> states = new Dictionary<Type, PlayerStateBase>()
            {
                ...
                (
                    ...
                    {
                        new PlayerTransition<JumpPlayerState, InputContext>
                        (
